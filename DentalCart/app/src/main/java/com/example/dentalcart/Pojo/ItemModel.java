...
public class ItemModel {
    ...
    public ItemModel(String category ,String description, String discount, String favorite, String id, String name, String photo, String rating, String price , int quantity) {
        this.description = description;
        this.discount = discount;
        this.favorite = favorite;
        this.id = id;
